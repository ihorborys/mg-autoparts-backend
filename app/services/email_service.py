...
#             total_uah = 0
#
#             # Отримуємо фіксовану суму в грн
#             total_uah_final = order_data.get('total_price_uah', 0)
#
#             for item in order_data.get('items', []):
#                 # Більше не рахуємо курс тут! Беремо готове значення з React
#                 item_price_uah = item.get('price_uah', 0)
...
class EmailService:
    ...
    def send_order_confirmation(order_data: dict):
        ...
        try:
            ...
            # Дані про гроші, які прийшли з React
            total_uah_final = order_data.get('total_price_uah', 0)
            ...
            for item in order_data.get('items', []):
                # Використовуємо готову ціну за одиницю з React
                item_price_uah = item.get('price_uah', 0)
                qty = int(item.get('quantity', 1))
                ...
                <div style="max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; padding: 25px; border-radius: 10px;">
                    <div style="text-align: center; border-bottom: 2px solid #d32f2f; padding-bottom: 10px; margin-bottom: 20px;">
                        <a href="https://maxgear.com.ua" target="_blank" rel="noopener">
                            <img src="https://pub-fcf51cc33cf647358f319200a346cc52.r2.dev/images/maxgear_logo.png" width="200px" alt="MaxGear Logo">
                        </a>
                    </div>
